...
function [timefacs,datafacs] = scan4_glm_loadfactors(session)
    ...
    for i_lsdata = 1:nb_lsdata
        ...
        data = load(file);
        fprintf('scan4_loadfactors: loading datafile: %s\n',file);
        scans{i_lsdata} = data;
    end
