...
function plot_data_rtpostexch_2(session)
    ...
    %% plot
    t = [t_early_exchno_pre',t_early_exchno_pos',t_later_exchno_pre',t_later_exchno_pos'];
    t(n_par,:) = [];
    m = mean(t);
    ...
    fig_barweb(m - 600,e,...
                        ...
                        [1,1,1;.8,.8,.8],...                                   colour
                        'y',...                                                grid
                        {'early pre','early pos','later pre','later pos'},...    legend
                        2,...                                                  error sides (1, 2)
