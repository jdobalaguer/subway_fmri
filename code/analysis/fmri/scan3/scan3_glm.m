...
function scan3_glm()
    ...
    if do_contrasts,    scan3_glm_secondcopy();         end     % second : copy
    if do_contrasts,    scan3_glm_secondcontrasts();    end     % second : contrast
    if do_contrasts,    scan3_glm_copycontrasts();      end     % copy contrasts
    toc();
