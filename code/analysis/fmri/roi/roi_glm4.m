...
function scan = roi_glm4()
    ...
    scan.glm.marge      = 5;
    scan.glm.name       = 'ROI4_spmt_outside';
    scan.glm.pooling    = true;
    scan.glm.outside    = 'ROI/mask/Outside.img';
    scan.glm.redo       = 1;
    ...
    jj_block        = get_rows(block.expt_subject, block.expt_session);
    jj_data         = get_rows( data.expt_subject,  data.expt_session); %ii_N,ii_R,ii_C,ii_L,ii_I,ii_R);
