...
function [timeruns,dataruns] = scan_generateregressors(datafiles)
    ...
    for i_datafile = 1:length(datafiles)
        ...
        for i_break = 1:(length(ii_break)-1)
            ...
            timerun.('avatar_face') = time_face;
            timerun.('avatar_place') = time_place;
            ...
            timerun.('avatar_switch') = time_switch;
            timerun.('avatar_noswitch') = time_noswitch;
            ...
            timerun.('avatar_forward'  ) = time_forward;
            timerun.('avatar_backwards') = time_backwards;
            ...
            timerun = rmfield(timerun,'screen_endblank');
