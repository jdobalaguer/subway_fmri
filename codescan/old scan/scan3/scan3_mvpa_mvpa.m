...
function scan3_mvpa_mvpa(tmp_workspace)
    tools_setworkspace;
    
    fprintf('\n\n');
    fprintf('scan3_mvpa: participant %02i ================================\n',i_sub);
    ...
    %% build subject
    fprintf('scan3_mvpa: build subject ---------------------------------\n');
    ...
    %% build pattern
    fprintf('scan3_mvpa: build pattern ---------------------------------\n');
    ...
    %% build regressors
    fprintf('scan3_mvpa: build regressors ------------------------------\n');
    ...
    % regressor
    tools_getworkspace;
    subj_condregs = scan3_mvpa_regressors(tmp_workspace);
    %subj_condregs = scan3_mvpa_randomregressors(tmp_workspace);
    clear('tmp_workspace');
    ...
    %% preprocessing
    fprintf('scan3_mvpa: preprocessing ---------------------------------\n');
    ...
    %% classification
    fprintf('scan3_mvpa: classification --------------------------------\n');
